...
INSERT INTO `actor_folder` VALUES (20,23),(20,24),(20,25),(20,26),(20,27),(20,28),(21,29),(21,30),(21,31),(21,32),(21,33),(21,34);
...
INSERT INTO `administrator` VALUES (20,0,'ponsavi@acme.org','Paco','656343000','Calle Fontenla, 2','Samper Villagrán',18),(21,0,'ponsavi@acme.org','Francisco','656343000','Calle Fontenla, 2','Samper Villagrán',19);
...
CREATE TABLE `bust` (
  ...
  `newspaper_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_4bwmg6ihasgfi1eko34fu7lla` (`ticker`),
  KEY `FK_o827upui7v5qgmf5397vbgyew` (`administrator_id`),
  KEY `FK_ctg3jcjd0d71l4m0ih04gwe32` (`newspaper_id`),
  CONSTRAINT `FK_ctg3jcjd0d71l4m0ih04gwe32` FOREIGN KEY (`newspaper_id`) REFERENCES `newspaper` (`id`),
  CONSTRAINT `FK_o827upui7v5qgmf5397vbgyew` FOREIGN KEY (`administrator_id`) REFERENCES `administrator` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `config` VALUES (22,0,'2018-01-20',0);
...
INSERT INTO `config_taboowords` VALUES (22,'sex'),(22,'sexo'),(22,'viagra'),(22,'cialis');
...
INSERT INTO `folder` VALUES (23,0,'Root','',NULL),(24,0,'Inbox','',23),(25,0,'Outbox','',23),(26,0,'Notification Box','',23),(27,0,'TrashBox','',23),(28,0,'Spam','',23),(29,0,'Root','',NULL),(30,0,'Inbox','',29),(31,0,'Outbox','',29),(32,0,'Notification Box','',29),(33,0,'TrashBox','',29),(34,0,'Spam','',29);
...
INSERT INTO `useraccount` VALUES (18,0,'21232f297a57a5a743894a0e4a801fc3','admin'),(19,0,'c84258e9c39059a89ab77d846ddab909','admin2');
...
INSERT INTO `useraccount_authorities` VALUES (18,'ADMIN'),(19,'ADMIN');
...
-- Dump completed on 2018-06-26 17:57:48
commit;